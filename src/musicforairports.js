...
$(document).ready(function() {
  ...
  new Tone.Loop(time => {
    leftSynth.triggerAttackRelease('C5', '1:2', time, 0.2)

    leftSynth.setNote('D5', '+0:2');

    leftSynth.triggerAttackRelease('E4', '0:2', '+6.0', 0.2);

    leftSynth.triggerAttackRelease('G4', '0:2', '+11:2', 0.2);

    leftSynth.triggerAttackRelease('E5', '2:0', '+19:0', 0.2);
  ...
  new Tone.Loop(time => {
    ...
    rightSynth.triggerAttackRelease('D4', '1:2', '+5:0', 0.2);

    rightSynth.setNote('E4', '+6.0');

    rightSynth.triggerAttackRelease('B3', '1m', '+11:2:2', 0.2);

    rightSynth.setNote('G3', '+12:0:2');

    rightSynth.triggerAttackRelease('G4', '0.2', '+23.2', 0.2);
